/*************************************************************************//**
 * @file    dev_IR_State_WaitingAck.h
 * @mcu		STM32F1x
...
/*************************************************************************//**
 * @fun     IR_State_WaitingAck
 * @brief   Waits for an Ack PDU during some time. If timeout is reached, a
 *			retransmission is started. This will continue till an ACK will be
 *			received or till an EV_CANCELLED will be received.
 *
...
/*************************************************************************//**
 * @fun     OnEntry
 * @brief   Handles ENTRY_SIG event. During this waiting state, it must wait
 *			for an event flag from the driver ISR. So this kind of waiting
 *			must be enable (WAITFOR_EVT) and a timeout must be especified.
 *
