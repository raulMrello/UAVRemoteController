 ...
 * @author  Raúl M.
 ****************************************************************************/
#ifndef __TEXTSANDLANGUAGES_EU0_H__
#define __TEXTSANDLANGUAGES_EU0_H__
...
#define PAIS_NORUEGA	3
#define PAIS_SUECIA		4
#define USE_LOADED		5	//!< IMPOTANT!!!! its value is 1 more than the last country
