 ...
 * @return  n/a
 ****************************************************************************/
void DialogBoxEx4_create(	void *pThis, 
							uint8_t type, 
							XCHAR *text_w, 
							XCHAR *text, 
							...
							XCHAR *leftText, XCHAR *rightText, StateHandler gts,
	...
	// Statictext
	StCreate(OBJ_STATICTEXT_1,17,22,110,32,ST_CENTER_ALIGN | ST_DRAW,text,me->altScheme);
