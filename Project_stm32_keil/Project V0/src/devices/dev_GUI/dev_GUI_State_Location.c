...
static const StateHandler Transitions[] = {GUI_State_CaptureLocation, GUI_State_StoredLocation, GUI_State_StoredCities};
#else
static const StateHandler Transitions[] = {GUI_State_StoredCities, GUI_State_StoredCities, GUI_State_StoredCities};
#endif
/*************************************************************************//**
 * @fun     OnFormCreate
...
static void OnFormCreate(void * pThis){
	...
	FlexMenu_Create(	pThis, 
						(XCHAR *)TEXTS[TIT_LOCALIZACION][me->language], 
						(XCHAR *)LSTBOX[LBX_LOCALIZACION][me->language], 
						(XCHAR *)0,
						NULL, 
						(XCHAR *)0, 
						(XCHAR *)0, 
