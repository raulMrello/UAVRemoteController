...
static State OnEntry(T_DEV_GUI * me, T_GUI_Message const * m){
	(void)m;	// not used
	// Allow timeout to TOP Transitions once menu entered
...
static const StateHandler Transitions[] = {GUI_State_Devices, GUI_State_Configuration, GUI_State_Location};
...
static void OnFormCreate(void * pThis){
	...
	FlexMenu_Create(	pThis, 
						(XCHAR *)TEXTS[TIT_MENU][me->language], 
						(XCHAR *)LSTBOX[LBX_MENU][me->language], 
						(XCHAR *)0,
						NULL, 
						(XCHAR *)0, 
						(XCHAR *)0, 
