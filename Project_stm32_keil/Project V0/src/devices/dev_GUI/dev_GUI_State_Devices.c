/*************************************************************************//**
 * @file    dev_GUI_State_Devices.h
 * @mcu		STM32F1x
 * @brief   GUI Device State Machine implementation for DEVICES form.
 * @date    20.07.2010
 * @author  Raúl M.
 ****************************************************************************/
...
static const StateHandler Transitions[] = {GUI_State_ReadDevice, GUI_State_StoredDevice};
...
static void OnFormCreate(void * pThis){
	...
	FlexMenu_Create(	pThis, 
						(XCHAR *)TEXTS[TIT_EQUIPOS][me->language], 
						(XCHAR *)LSTBOX[LBX_EQUIPOS][me->language], 
						(XCHAR *)0,
						NULL, 
						(XCHAR *)0, 
						(XCHAR *)0, 
