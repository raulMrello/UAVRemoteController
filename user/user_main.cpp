...
struct GPSTask : fdv::Task
{

	GPSTask(fdv::Serial* serial)
...
struct MainTask : fdv::Task
{
	void ICACHE_FLASH_ATTR exec()
	{
		...
		serial.printf(FSTR("\n\rUAV Remote Controller started.\n\r"));
		
		// Client mode with dynamic IP
		fdv::WiFi::setMode(fdv::WiFi::Client);
		fdv::WiFi::configureClient("QC_wifi", "r231190m");
		fdv::IP::configureDHCP(fdv::IP::ClientNetwork);
		serial.printf(FSTR("Ok\n\r"));

		// starts TCP client
//TODO		new fdv::TCPClient<MyTCPConnectionHandler>(80);
