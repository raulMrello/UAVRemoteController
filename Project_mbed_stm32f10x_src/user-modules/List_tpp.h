...
//------------------------------------------------------------------------------------
template<typename T>
void List<T>::setLimit(uint32_t numItems) throw (ListException){
	if(!numItems){
		throw NULL_POINTER;
	}
	_numItems = numItems;
...
//------------------------------------------------------------------------------------
template<typename T>
void List<T>::addItem(T* item) throw (ListException){
	if(!item){
		throw NULL_POINTER;
	}
	if(_count >= _numItems){
...
//------------------------------------------------------------------------------------
template<typename T>
void List<T>::removeItem(T* item) throw (ListException){
	if(!item){
		throw NULL_POINTER;
	}
	ListItem* listitem;
...
//------------------------------------------------------------------------------------
template<typename T>
bool List<T>::searchItem(T* item) throw (ListException){
	if(!item){
		throw NULL_POINTER;
	}
	T* i = getFirstItem();
